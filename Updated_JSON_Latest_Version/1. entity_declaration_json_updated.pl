...
lexical_rule([cat:noun, num:sg, type:entity, pos:subj, sem:Sems], List1, List2) :-  
   ...
   assert(lexicon([cat:noun, wform:WForm, num:sg, type:entity, pos:subj, init:yes, arg:X, sem:Sems])), 
   assert(lexicon([cat:noun, wform:DWForm, num:sg, type:entity, pos:subj, init:no, arg:X, sem:Sems])), 
   assert(lexicon([cat:noun, wform:DWForm, num:sg, type:entity, pos:obj, arg:X, sem:Semo])), 
   assert(lexicon([cat:noun, wform:PWForm, num:pl, type:entity, pos:obj, arg:X, sem:Semo])).  
