...
np([num:N, type:const, pos:subj, arg:X, arg:Y, sco:S, sem:Sem]) -->                 
  det([wform:['No'], num:N, type:const, arg:X, res:R, sco:json(['Var'=Y, 'Neg'=S]), sem:Sem]),
...
np([num:N, type:const, pos:subj, arg:X, sco:Sco, sem:Sem]) -->
   det([num:N, type:const, pos:subj, arg:X, res:json(['Atom'=Res]), sco:Sco, sem:Sem]),
   noun([num:sg, type:const, pos:subj, arg:X, sem:Res]).

np([num:N, type:const, pos:obj, arg:X, sem:Sem]) -->
   det([num:N, type:const, pos:obj, arg:X, sco:Sco, sem:Sem]),
   noun([num:N, type:const, pos:obj, arg:X, sem:Sco]).
...
det([num:N, type:const, pos:obj, arg:X, sco:Sco,  
					sem:json(['Atom'=Sco])]) --> [a].
