...
s([type:bfact_ob, sem:json(['Atom'=[Res, Sco]])]) -->  
  ...
  verb([wform:[objectifies], num:N, type:fact_ob, arg:X, arg:L, sem:Sco]),
...
verb([wform:[objectifies], num:N, type:fact_ob, arg:X, arg:Y, sem:Sem]) -->
  { lexicon([cat:verb, wform:[objectifies], num:N, type:ob_rel, arg:X, arg:Y, sem:Sem]) },
  [objectifies].
...
% ----------------------------------------
% |Exclusion Constraint(fact) Declaration|
% ----------------------------------------
...
np([num:N, type:const, pos:subj, arg:X, arg:Y, sco:S, sem:Sem]) -->                 
  det([wform:['No'], num:N, type:const, arg:X, res:json(['Atom'=R]), sco:json(['Var'=Y, 'Neg'=S]), sem:Sem]),
  noun([num:N, type:const, pos:subj, arg:X, sem:R]).                          
    
np([num:_N, type:const, pos:obj, arg:X, sco:S, sem:Sem]) -->       
  det([wform:[a], num:N, type:const, arg:X, res:R, sco:S, sem:Sem]),
  noun([num:N, type:const, pos:obj, arg:X, sem:R]).

np_([num:_N, type:const, pos:obj, arg:X, sco:S, sem:Sem]) -->       
  det([wform:[the], num:N, type:const, arg:X, res:R, sco:S, sem:Sem]),
  noun([num:N, type:const, pos:obj, arg:X, sem:R]).  

vp([num:N, type:const, arg:X, arg:Y, sem:json(['And'=[S1,S2]])]) -->
  vp([crd:'X', num:N, type:const, arg:X, arg:Y, sem:S1]),
  cc([wform:[and]]),
  vp([crd:'+', num:N, type:const, arg:X, arg:Y, sem:S2]).
  
vp([crd:'X', num:N, type:const, arg:X, arg:Y, sem:Sem]) -->   
  verb([num:N, type:const, arg:X, arg:Y, sem:S]),
  np([num:_N, type:const, pos:obj, arg:Y, sco:S, sem:Sem]).

vp([crd:'+', num:N, type:const, arg:X, arg:Y, sem:json(['And'=[S1,S2]])]) -->   
  vp([crd:'-', num:N, type:const, arg:X, arg:Y, sem:S1]),
  cc([wform:[and]]),
  vp([crd:'+', num:N, type:const, arg:X, arg:Y, sem:S2]).

vp([crd:'+', num:N, type:const, arg:X, arg:Y, sem:Sem]) -->   
  verb([num:N, type:const, arg:X, arg:Y, sem:S]),
  np_([num:_N, type:const, pos:obj, arg:Y, sco:S, sem:Sem]).

vp([crd:'-', num:N, type:const, arg:X, arg:Y, sem:Sem]) -->   
  verb([num:N, type:const, arg:X, arg:Y, sem:S]),
  np_([num:_N, type:const, pos:obj, arg:Y, sco:S, sem:Sem]).  

det([wform:WForm, num:N, type:const, arg:X, res:R, sco:S, sem:Sem]) --> 
...
lexicon([cat:det, wform:[the], num:sg, arg:X, res:Res, sco:Sco,
         sem:json(['Atom'=[ Sco, Res ]])]).		
...
np([num:N, type:const_dp, pos:P, arg:X, sco:Sco, sem:Sem]) -->
   qnt([num:N, type:const_dp, pos:P, arg:X, res:json(['Atom'=Res]), sco:json(['Exists'=Sco]), sem:Sem]),
...
vp([crd:'+', num:N, type:const_dp, arg:X, sem:[S1, S2]]) -->   
...
% --------------------------------------
% |Subtype Declaration (Inheritance)|
% --------------------------------------
...
verb([wform:Wform]) --> [is, a]; [is, an].


% --------------------------------------
% |Inclusive-Or Constraint Declaration |
% --------------------------------------

s([type:const, sem:Sem]) -->
   np([num:N, type:const, pos:subj, arg:X, sco:Sco, sem:Sem]),
   vp([crd:'+', num:N, type:const, arg:X, sem:Sco]),
   ['.'].

np([num:N, type:const, pos:P, arg:X, sco:Sco, sem:Sem]) -->
   qnt([num:N, type:const, pos:P, arg:X, res:json(['Atom'=Res]), sco:Sco, sem:Sem]),
   noun([num:sg, type:const, pos:P, arg:X, sem:Res]).

np([num:N, type:const, pos:P, arg:X, sem:Sem]) -->
   det([wform:Wform]),
   noun([num:N, type:const, pos:P, arg:X, sem:Sem]).
...
vp([crd:'+', num:N, type:const, arg:X, sem:json(['Or'=json(['Atom'=[S1, S2]])])]) -->   
  vp([crd:'-', num:N, type:const, arg:X, sem:S1]),
  cc([wform:[or]]),
  vp([crd:'+', num:N, type:const, arg:X, sem:S2]).

vp([crd:'+', num:N, type:const, arg:X, sem:Sem]) -->   
  copula([wform:[is]]),  
  np([num:_N, type:const, pos:obj, arg:X, sem:Sem]).
...
qnt([num:N, type:const, pos:subj, arg:X, res:JsonHead, sco:JsonBody, 
					sem:json(['Forall'=json(['Var'=X, 
						'Implies'= json([head=JsonHead, body=JsonBody])])])]) --> ['Each'].
   

% ------------------------------------------
% |Exclusion Constraint(Entity) Declaration|
% ------------------------------------------
...
np([num:N, type:const, pos:subj, arg:X, sco:Sco, sem:Sem]) -->
   det([num:N, type:const, pos:subj, arg:X, res:json(['Atom'=Res]), sco:json(['Atom'=Sco]), sem:Sem]),
   noun([num:sg, type:const, pos:subj, arg:X, sem:Res]).

np([num:N, type:const, pos:obj, arg:X, sem:Sem]) -->
   det([wform:Wform]),
   noun([num:N, type:const, pos:obj, arg:X, sem:Sem]).
...
vp([crd:'+', num:N, type:const, arg:X, sem:json(['And'=[S1,S2]])]) -->   
  vp([crd:'-', num:N, type:const, arg:X, sem:S1]),
  cc([wform:[and]]),
  vp([crd:'+', num:N, type:const, arg:X, sem:S2]).
...
det([num:N, type:const, pos:subj, arg:X, res:JsonHead, sco:JsonBody, 
					sem:json(['Forall'=json(['Var'=X, 
						'Implies'= json([head=JsonHead, body=json(['Neg'=JsonBody])])])])]) --> ['No'].
   


% ------------------------------------------
% |Subset Constraint(fact) Declaration|
% ------------------------------------------
...
lexicon([cat:verb, wform:[objectifies], num:sg, type:ob_rel, arg:X, arg:Y, sem:json(['Rel'=relation, 'Ind'=objectifies, 'Var'=X, 'Reify'=Y])]).

cc([wform:[and]]) --> [and]. 
cc([wform:[or]]) --> [or].  
det([wform:Wform]) --> [a];[an].
copula([wform:[is]]) --> [is].
