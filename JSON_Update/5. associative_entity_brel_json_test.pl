...
s([type:fact_ob, sem:Sem]) -->  
  ...
  verb([wform:[associates], num:N, type:fact_ob, sub:S, arg:X, arg:json(['And'=json(['Atom'=L])]), sem:Sem]),
...
s([type:ob_bfact, sem:Sem]) --> 
  np([num:N, type:ob_bfact, func:subj, arg:X, rel:Sem, sem:S]), 
  vp([num:N, type:ob_bfact, arg:X, sub:S, sem:Sem]).

vp([num:N, type:ob_bfact, arg:X, sub:S, sem:[S,Sem,O]])-->
  verb([num:N, type:ob_bfact, arg:X, arg:Y, sem:Sem]),
  np([num:_N, type:ob_bfact, func:obj, arg:Y, sem:O]).
  
np([num:N, type:ob_bfact, func:obj, arg:Y, sem:Sem]) -->
  {lexicon([cat:noun, wform:WForm, num:N, type:entity, pos:obj, arg:Y, sem:Sem]) }, 
  WForm.
  
np([num:N, type:ob_bfact, func:subj, arg:X, rel:[S,Sem,O], sem:S]) -->
