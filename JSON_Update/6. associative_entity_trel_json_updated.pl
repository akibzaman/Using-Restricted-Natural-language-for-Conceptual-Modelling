...
s([type:ob_tfact, rel:R, sem:json(['And'=json(['Atom'=[Res|Sco]])])]) --> 
  ...
  vp([num:N, type:ob_tfact, rel:R, arg:X, sem:Sco]).

vp([num:N, type:ob_tfact, rel:R, arg:X, sem:[V,Ob1,Ob2]])-->
  verb([type:ob_tfact, wform:[WForm1, WForm2], pos:beg, arg:X, arg:Y, arg:Z, sem:V]),
  np([num:N, type:ob_tfact, pos:obj, arg:Y, sem:Ob1]),
  verb([type:ob_tfact, wform:[WForm1, WForm2], pos:end, sem:_V]),
...
verb([type:ob_tfact, wform:[WForm1, WForm2], pos:end, sem:V])--> 
   {lexicon([cat:verb, wform:[WForm1,WForm2], num:sg, type:trel, arg:X, arg:Y, arg:Z, sem:V]) }, WForm2.
