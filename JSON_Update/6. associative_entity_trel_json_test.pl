...
s([type:ob_tfact, rel:R, sem:L]) --> 
  np([num:N, type:ob_tfact, pos:subj, arg:X, sem:S]),  
  vp([num:N, type:ob_tfact, rel:R, sub:S, arg:X, arg:Y, arg:Z, sem:L]).

vp([num:N, type:ob_tfact, rel:R, sub:S, arg:X, arg:Y, arg:Z, sem:[S,V,Ob1,Ob2]])-->
