...
noun([num:N, type:T, pos:P, arg:X, sem:Sem]) -->
  {lexicon([cat:noun, wform:WForm, num:N, type:entity, stype:rel_dec, pos:P, arg:X, sem:Sem]) },
  WForm.
...
vp([num:N, type:ob_tfact, arg:X, sem:[V, Ob1, Ob2]])-->
  verb([type:ob_tfact, wform:[WForm1, WForm2], arg:X, arg:Y, arg:Z, sem:V]),
  np([num:N, type:ob_tfact, pos:obj, arg:Y, sem:Ob1]),
  verb([type:ob_tfact, wform:[WForm1, WForm2], sem:_V]),
...
lexicon([cat:noun, wform:['Enrolment'], num:sg, type:entity, stype:rel_dec, pos:subj, arg:X, sem:json(['Rel'=entity, 'Ind'=enrolment, 'Var'=X])]).

lexicon([cat:noun, wform:['Student'], num:sg, type:entity, stype:rel_dec, pos:subj, arg:X, sem:json(['Rel'=entity, 'Ind'=student, 'Var'=X])]).   

lexicon([cat:noun, wform:['unit'], num:sg, type:entity, stype:rel_dec, pos:obj, arg:X, sem:json(['Rel'=entity, 'Ind'=unit, 'Var'=X])]).

lexicon([cat:noun, wform:['program'], num:sg, type:entity, stype:rel_dec, pos:obj, arg:X, sem:json(['Rel'=entity, 'Ind'=program, 'Var'=X])]).  
