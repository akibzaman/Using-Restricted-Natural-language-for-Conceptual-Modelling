...
noun([mode:M, num:N, type:fact, pos:obj, arg:Y, sem:Sem]) -->
  {lexicon([cat:noun, wform:WForm, num:N, type:entity, stype:rel_dec, pos:obj, arg:Y, sem:Sem]) }, 
  WForm.

noun([mode:M, num:N, type:fact, pos:subj, arg:X,  sem:Sem]) -->       % FIXED
  {lexicon([cat:noun, wform:WForm, num:N, type:entity, stype:rel_dec, pos:subj, arg:X, sem:Sem]) },
  WForm.
...
lexicon([cat:noun, wform:['Department'], num:sg, type:entity, stype:rel_dec, pos:subj, arg:X, sem:json(['Rel'=entity, 'Ind'=department, 'Var'=X])]).
